...
fn test_storage_size_limit_discovery() {
    ...
    if !reached_limit {
        println!("SUCCESS (?): Contract handled 2000 receipts without hitting storage size limits.");
    }
}
...
fn test_gas_exhaustion_on_sorting() {
    ...
    for i in 1..=500 {
        ...
        if i % 100 == 0 {
            ...
            println!("Pagination CPU cost at {} receipts: {} instructions", i, end_cpu - start_cpu);
        }
    }
}
